const version = '0.9.6';
const author = '@ovbml';
const lastEditDate = new Date(Date.UTC(2021, 9, 21, 22, 22));
...
const changeList = {
    ...
    '0.9.6': [
        'Добавил изменение параметров при изменении изображения, чтобы можно было дать ссылку другу на уже определенное изображение',
    ],
};
